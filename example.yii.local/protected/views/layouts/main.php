...
<head>
    ...
    <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/assets/css/theme.css" />
    <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/assets/css/MoneAdmin.css" />
    <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/assets/plugins/Font-Awesome/css/font-awesome.css" />
    <!--END GLOBAL STYLES -->
    ...
    <div id="left">
        <div class="media user-media well-small">
            <a class="user-link" href="#">
                <img class="media-object img-thumbnail user-img" alt="User Picture" src="<?php echo Yii::app()->request->baseUrl; ?>/assets/img/user.gif" />
            </a>
            <br />
...
<script src="<?php echo Yii::app()->request->baseUrl; ?>/assets/plugins/modernizr-2.6.2-respond-1.1.0.min.js"></script>
<!-- END GLOBAL SCRIPTS -->
</body>
<!-- END BODY-->
